...
case class AXIFireFlyPackedv3(
  ...
  val leaky = Bool() setAsReg() init false
  ...
  configCtrl.write(numOfTimeStepIFMs, 0x04, 0)
  configCtrl.write(numOfTimeStepOFMs, 0x04, 12)

  configCtrl.write(weightsLength, 0x08, 0)
  configCtrl.write(threshold, 0x08, 14)

  configCtrl.write(width, 0x0C, 0)
  configCtrl.write(height, 0x0C, 16)
  configCtrl.write(enablePooling, 0x0C, 28)
  configCtrl.write(directWidthAdapt, 0x0C, 29)
  configCtrl.write(winner_takes_all, 0x0C, 30)
  configCtrl.write(leaky, 0x0C, 31)
  ...
  configCtrl.write(strideOfChannel, 0x24, 0)
  configCtrl.write(mm2sBaseAddr, 0x28, 0)
  configCtrl.write(s2mmBaseAddr, 0x2C, 0)
  configCtrl.write(mm2sFixLen, 0x30, 0)
  configCtrl.write(s2mmFixLen, 0x34, 0)
  configCtrl.write(weightTranAddr, 0x38, 0)
  configCtrl.write(weightTranLen, 0x3C, 0)
  configCtrl.write(biasTranAddr, 0x40, 0)
  configCtrl.write(biasTranLen, 0x44, 0)

  configCtrl.write(mm2sStartPulse, 0x48, 0)
  configCtrl.write(s2mmStartPulse, 0x48, 8)
  configCtrl.write(paramStartPulse, 0x48, 16)
  ...
  //  configCtrl.read(Delay(s2mmCmdGen.io.busy, 4), 0x50, 4)
  //  configCtrl.read(Delay(io.inputs.valid, 4), 0x50, 8)
  //  configCtrl.read(Delay(io.inputs.ready, 4), 0x50, 12)
  //  configCtrl.read(Delay(io.outputs.valid, 4), 0x50, 16)
  //  configCtrl.read(Delay(io.outputs.ready, 4), 0x50, 20)
  //  configCtrl.read(Delay(io.params.valid, 4), 0x50, 24)
  //  configCtrl.read(Delay(io.params.ready, 4), 0x50, 28)
